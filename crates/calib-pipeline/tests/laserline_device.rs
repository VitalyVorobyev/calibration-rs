...
use calib_optim::{LaserPlane, LaserlineMeta, LaserlineView};
use calib_pipeline::laserline_device::{
    run_calibration, LaserlineDeviceConfig, LaserlineDeviceProblem,
};
...
fn pipeline_converges_pinhole() {
    ...
    let _: calib_pipeline::laserline_device::LaserlineDeviceOutput =
