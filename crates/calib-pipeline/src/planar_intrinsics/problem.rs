...
use calib_core::{DistortionFixMask, IntrinsicsFixMask, PlanarDataset};
...
pub struct PlanarConfig {
    ...
    pub robust_loss: calib_optim::RobustLoss,
...
impl Default for PlanarConfig {
    fn default() -> Self {
        Self {
            ...
            max_iters: 50,
            verbosity: 0,
            robust_loss: calib_optim::RobustLoss::None,
...
impl PlanarConfig {
    /// Convert to calib-linear initialization options.
    ...
    /// Convert to calib-optim solve options.
...
mod tests {
    use super::*;
    use calib_core::{CorrespondenceView, NoMeta, Pt2, Pt3, View};
    ...
    fn config_json_roundtrip() {
        ...
        match restored.robust_loss {
            calib_optim::RobustLoss::Huber { scale } => {
    ...
    fn solve_opts_conversion() {
        let config = PlanarConfig {
            robust_loss: calib_optim::RobustLoss::Cauchy { scale: 1.0 },
            fix_poses: vec![0, 1],
            ..Default::default()
        };
        ...
        match opts.robust_loss {
            calib_optim::RobustLoss::Cauchy { scale } => {
