...
pub struct LaserlineDeviceConfig {
    ...
    pub calib_loss: calib_optim::RobustLoss,
    /// Robust loss for laser residuals.
    pub laser_loss: calib_optim::RobustLoss,
...
impl Default for LaserlineDeviceConfig {
    fn default() -> Self {
        Self {
            ...
            max_iters: 50,
            verbosity: 0,
            calib_loss: calib_optim::RobustLoss::Huber { scale: 1.0 },
            laser_loss: calib_optim::RobustLoss::Huber { scale: 0.01 },
            calib_weight: 1.0,
            laser_weight: 1.0,
