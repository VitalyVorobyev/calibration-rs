...
| `RigHandeyeProblem` | `RigDataset<RobotPoseMeta>` | 6 steps. Pinhole or Scheimpflug rig — set `RigHandeyeConfig::sensor` to `SensorMode::Pinhole` (default) or `SensorMode::Scheimpflug { … }`. |
